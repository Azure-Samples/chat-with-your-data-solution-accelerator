...
def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    # Set up LLM Helper
    docuement_processor = DocumentProcessor()
    # Get all files from Blob Storage
    files_data = docuement_processor.blob_client.get_all_files()
    ...
    queue_client = QueueClient.from_connection_string(docuement_processor.blob_client.connect_str, queue_name, message_encode_policy=BinaryBase64EncodePolicy())
