...
param virtualMachineAdminUsername = readEnvironmentVariable('AZURE_ENV_VM_ADMIN_USERNAME', '')
param virtualMachineAdminPassword = readEnvironmentVariable('AZURE_ENV_VM_ADMIN_PASSWORD', '')
