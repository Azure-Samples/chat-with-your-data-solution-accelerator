...
module web_docker './app/web.bicep' =
  if (hostingModel == 'container') {
...
module function_docker './app/function.bicep' =
  if (hostingModel == 'container') {
...
// Contributor
module openaiRoleUserContributor 'core/security/role.bicep' =
  if (authType == 'rbac') {
    scope: rg
