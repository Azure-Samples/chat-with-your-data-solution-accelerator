...
| [0021](0021-agent-framework-foundry-iq-kb-default.md) | `agent_framework` default + Foundry IQ Knowledge Base retrieval (`searchIndex` over `cwyd-index`; KB API version env-pinned) | Accepted | 8 |
