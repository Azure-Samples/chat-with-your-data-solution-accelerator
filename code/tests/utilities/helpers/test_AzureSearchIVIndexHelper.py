...
# def test_create_or_update_index_keys(env_helper_mock: MagicMock, search_index_client_mock: MagicMock, search_index_mock: MagicMock, vector_seach_mock: MagicMock, semantic_search_mock: MagicMock):
#     # given
#     azure_search_iv_index_helper = AzureSearchIVIndexHelper(env_helper_mock)

#     # when
#     azure_search_index = azure_search_iv_index_helper.create_or_update_index()

#     # then
#     assert azure_search_index.name == search_index_client_mock.create_or_update_index(search_index_mock).return_value.name
