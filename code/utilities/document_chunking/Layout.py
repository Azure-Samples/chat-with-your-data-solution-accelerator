...
class LayoutDocumentChunking(DocumentChunkingBase):
    """Class for chunking documents based on layout."""
    ...
    def chunk(
        ...
        """
        Chunk the given documents based on the layout.

        Args:
            documents (List[SourceDocument]): List of source documents to be chunked.
            chunking (ChunkingSettings): Chunking settings.

        Returns:
            List[SourceDocument]: List of chunked source documents.
        """
