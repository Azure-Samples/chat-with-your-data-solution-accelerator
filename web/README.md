...
|REACT_APP_AZURE_SPEECH_KEY||The key for the Azure Speech Service for handling speech-to-text|
|REACT_APP_AZURE_SPEECH_REGION||The region for the Azure Speech Service for handling speech-to-text|
...
- [Azure Speech Service Documentation](https://learn.microsoft.com/en-us/azure/ai-services/speech-service/index-speech-to-text)
